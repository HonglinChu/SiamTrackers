...
from siamcar.utils.lr_scheduler import build_lr_scheduler
from siamcar.utils.log_helper import init_log, print_speed, add_file_handler
from siamcar.utils.distributed import dist_init, reduce_gradients,average_reduce, get_rank, get_world_size
from siamcar.utils.model_load import load_pretrain, restore_from
from siamcar.utils.average_meter import AverageMeter
from siamcar.utils.misc import describe, commit
from siamcar.models.model_builder import ModelBuilder

from siamcar.datasets.dataset import TrkDataset
...
parser.add_argument('--cfg', type=str, default='./models/siamcar_alex/config.yaml',
