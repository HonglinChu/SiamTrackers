...
parser.add_argument('--config', default='./models/siamrpnpp_alexnet/config.yaml', type=str,help='config file')
parser.add_argument('--snapshot', default='./models/siamrpnpp_alexnet/snapshot/checkpoint_e49.pth', type=str,help='snapshot of models to eval')
