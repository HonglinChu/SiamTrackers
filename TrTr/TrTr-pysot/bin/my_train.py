...
from trtr.utils.lr_scheduler import build_lr_scheduler
from trtr.utils.log_helper import init_log, print_speed, add_file_handler
from trtr.utils.distributed import dist_init, my_dist_init, DistModule, reduce_gradients,\
        average_reduce, get_rank, get_world_size
from trtr.utils.model_load import load_pretrain, restore_from
from trtr.utils.average_meter import AverageMeter
from trtr.utils.misc import describe, commit
from trtr.models.model_builder import ModelBuilder
from trtr.datasets.dataset import BANDataset
from trtr.core.config import cfg


logger = logging.getLogger('global')
parser = argparse.ArgumentParser(description='siamese tracking')
parser.add_argument('--cfg', type=str, default='./models/trtr/config.yaml',help='configuration of tracking')
