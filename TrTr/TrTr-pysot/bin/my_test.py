...
parser.add_argument('--tracker_name', '-t', default='trtr',type=str,help='tracker name')

parser.add_argument('--config', default='./models/trtr/config.yaml',  type=str,help='config file')

parser.add_argument('--snapshot', default='./models/snapshot/checkpoint_e32.pth', type=str,help='snapshot of models to eval')
