...
from siamban.utils.distributed import dist_init, my_dist_init, DistModule, reduce_gradients,\
...
parser.add_argument('--cfg', type=str, default='./models/siamban/config.yaml',help='configuration of tracking')
