...
parser.add_argument('--dataset', default='VOT2019', type=str,help='datasets')

parser.add_argument('--tracker_name', '-t', default='siamban',type=str,help='tracker name')

parser.add_argument('--config', default='./models/siamban/config.yaml',  type=str,help='config file')

parser.add_argument('--snapshot', default='./models/snapshot/checkpoint_e45.pth', type=str,help='snapshot of models to eval')
