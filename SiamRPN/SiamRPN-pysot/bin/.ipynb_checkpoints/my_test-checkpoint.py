...
config,snapshot,video,param=select_model(1)  #选择模式1  SiamRPN 

#跟踪器的名字
#model_name='SiamFC'    #256通道+alexnet
#model_name='DaSiamRPN' #512通道+alexnet
#tracker_name='SiamRPN++'#256通道+alenxnet+depthwise
#data='VOT2018'          #测试数据集

parser = argparse.ArgumentParser(description='siamrpn tracking')
parser.add_argument('--dataset', '-d', default='VOT2018',type=str,help='datasets')
parser.add_argument('--tracker_name', '-t', default='SiamRPN++',type=str,help='tracker  name')
