...
---------------------------------------------------------------------------------------------------
| checkpoint_e27-16_r287_pk-0.120_wi-0.380_lr-0.320 |  0.563   |   0.375    |    80.0     | 0.300 |
---------------------------------------------------------------------------------------------------
...
-----------------------------------------------------
| SiamRPN++  |  0.623  |     0.000      |   0.837   |
-----------------------------------------------------

''' 

parser = argparse.kArgumentParser(description='Hyperparamter search')
parser.add_argument('--snapshot', default='./models/siamrpnpp_alexnet/snapshot/checkpoint_e41-16b-dp-up.pth',type=str, help='snapshot of model')
parser.add_argument('--dataset', default='VOT2018',type=str, help='dataset name to eval')
parser.add_argument('--penalty-k', default='0.13, 0.135, 0.14', type=parse_range)#0.16  
parser.add_argument('--lr', default='0.30, 0.31, 0.32', type=parse_range) #0.30   
parser.add_argument('--window-influence', default='0.40, 0.41, 0.42', type=parse_range)#0.40  
