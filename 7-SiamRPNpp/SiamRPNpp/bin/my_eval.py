...
#跟踪器的名字
# tracker_prefix='SiamFC'   #256通道+alexnet
#tracker_prefix='DaSiamRPN' #512通道+alexnet

tracker_prefix='SiamRPN++'   #256通道+alenxnet+depthwise
dataset='VisDrone'
...
parser.add_argument('--tracker_prefix', '-t', default=tracker_prefix,
