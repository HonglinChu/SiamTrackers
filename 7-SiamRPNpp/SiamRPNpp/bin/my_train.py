...
#CUDA_VISIBLE_DEVICES=0,1 #可见的gpu编号，我的电脑配置是两块GPU
...
config_path='/home/ubuntu/pytorch/pytorch-tracking/pysot-master/experiments/siamrpn_alex_dwxcorr_16gpu/config.yaml'
