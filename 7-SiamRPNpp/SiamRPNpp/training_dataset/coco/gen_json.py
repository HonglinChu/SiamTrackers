...
abspath='/media/ubuntu/942dfa3a-9dbd-486b-8be7-a3f77dcbf943/Datasets/COCO'
dataDir=abspath+'/coco'
...
for dataType in ['val2017', 'train2017']:
    ...
    json.dump(dataset, open(abspath+'/crop511/{}.json'.format(dataType), 'w'), indent=4, sort_keys=True)
    print('finished!')
