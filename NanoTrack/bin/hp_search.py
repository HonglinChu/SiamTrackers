...
parser.add_argument('--penalty-k', default='0.130, 0.140, 0.150, 0.160, 0.170', type=parse_range) 
parser.add_argument('--lr', default='0.360,  0.370,  0.380,  0.390,  0.400', type=parse_range) 
parser.add_argument('--window-influence', default='0.45, 0.455, 0.460', type=parse_range) #0.40  
