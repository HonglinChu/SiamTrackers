...
from siamfcpp.evaluation.got_benchmark.experiments import ExperimentDTB70
...
class DTB70Tester(TesterBase):
    ...
    def __init__(self, *args, **kwargs):
        super(DTB70Tester, self).__init__(*args, **kwargs)
...
DTB70Tester.default_hyper_params = copy.deepcopy(DTB70Tester.default_hyper_params)
DTB70Tester.default_hyper_params.update(DTB70Tester.extra_hyper_params)
