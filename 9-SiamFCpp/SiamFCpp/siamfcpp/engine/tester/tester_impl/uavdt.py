...
from siamfcpp.evaluation.got_benchmark.experiments import ExperimentUAVDT
...
class UAVDTTester(TesterBase):
    ...
    def __init__(self, *args, **kwargs):
        super(UAVDTTester, self).__init__(*args, **kwargs)
    ...
    def test(self, ):
        ...
        experiment = ExperimentUAVDT(root_dir,
...
UAVDTTester.default_hyper_params = copy.deepcopy(UAVDTTester.default_hyper_params)
UAVDTTester.default_hyper_params.update(UAVDTTester.extra_hyper_params)
