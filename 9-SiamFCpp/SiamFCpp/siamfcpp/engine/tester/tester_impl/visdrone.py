...
from siamfcpp.evaluation.got_benchmark.experiments import ExperimentVisDrone
...
class VisDroneTester(TesterBase):
    r"""OTB tester
    ...
    def __init__(self, *args, **kwargs):
        super(VisDroneTester, self).__init__(*args, **kwargs)
    ...
    def test(self, ):
        ...
        experiment = ExperimentVisDrone(root_dir,
    ...
    def worker(self, dev_id, dev, slicing_quantile):
...
VisDroneTester.default_hyper_params = copy.deepcopy(VisDroneTester.default_hyper_params)
VisDroneTester.default_hyper_params.update(VisDroneTester.extra_hyper_params)
