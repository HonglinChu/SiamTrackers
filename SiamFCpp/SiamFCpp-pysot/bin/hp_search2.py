...
parser.add_argument('--snapshot', default='./models/snapshot/checkpoint_e20.pth',type=str, help='snapshot of model')
parser.add_argument('--dataset', default='VOT2018',type=str, help='dataset name to eval')
parser.add_argument('--penalty-k', default='0.23, 0.24', type=parse_range)#0.16  
parser.add_argument('--lr', default='0.33, 0.34, 0.35, 0.36, 0.37', type=parse_range) #0.30   
parser.add_argument('--window-influence', default='0.45, 0.46, 0.47', type=parse_range)#0.40  
parser.add_argument('--search-region', default='255', type=parse_range_int)# 287
parser.add_argument('--config', default='./models/siamcar_alexnet/config.yaml', type=str)
