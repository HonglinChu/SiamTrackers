...
def main():
    ...
    parser.add_argument('--update_path', default='./models/vot2018.pth.tar', type=str, help='eval one special video')
    ...
    gpu_id=0
    tracker = SiamRPNTracker(model_path,update_path,gpu_id,step)#1=dasiamrpn; 2 linear; 3 updatenet
    # create dataset
