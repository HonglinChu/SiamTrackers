...
from siamrpnpp.datasets.dataset import TrkDataset  # no mask 
# from siamrpnpp.datasets.dataset_mask import DataSets # mask  

from siamrpnpp.core.config import cfg

logger = logging.getLogger('global')
parser = argparse.ArgumentParser(description='siamrpn tracking')
parser.add_argument('--cfg', type=str, default='./models/siammask_resnet/config-base.yaml',
...
def build_data_loader():
    ...
    # train_dataset
    train_dataset = TrkDataset()# no  mask 
    # train_dataset = DataSets()# mask 
