...
from siamrpnpp.utils.bbox import center2corner, Center
from siamrpnpp.datasets.anchor_target import AnchorTarget
from siamrpnpp.datasets.augmentation import Augmentation
...
class SubDataset(object):
    def __init__(self, name, root, anno, frame_range, num_use, start_idx):
        ...
        self.has_mask = self.name in ['COCO', 'VOS']
...
class TrkDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if dataset.has_mask and not neg:
            ...
            # print("search_mask:", search_mask.shape)  # search_mask: (511, 511)
        else:
        ...
        if dataset.has_mask and not neg: 
            ...
            # print("mask_weight1:", mask_weight.shape)  # mask_weight1: (1, 25, 25)
        else:
            mask_weight = np.zeros([1, cls.shape[1], cls.shape[2]], dtype=np.float32)
            # print("mask_weight2:", mask_weight.shape)  # mask_weight2: (1, 25, 25)
        ...
        # print("mask:", mask)
        # print("mask:", mask.shape)  # mask: (1, 255, 255)
