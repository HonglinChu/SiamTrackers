...
__C.DATASET.NAMES = ()  #('VID', 'COCO', 'DET', 'YOUTUBEBB', 'GOT')

__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = 'data/vid/crop511'
__C.DATASET.VID.ANNO = 'data/vid/train.json'
__C.DATASET.VID.FRAME_RANGE = 100
__C.DATASET.VID.NUM_USE = -1  # 100000# repeat until reach NUM_USE
...
__C.DATASET.GOT.NUM_USE = 50000  # use all not repeat -1   64000
...
__C.DATASET.VOS = CN()
__C.DATASET.VOS.ROOT = 'data/ytb_vos/crop511'
__C.DATASET.VOS.ANNO = 'data/ytb_vos/train.json'
__C.DATASET.VOS.FRAME_RANGE = 20 
__C.DATASET.VOS.NUM_USE = 100000  # repeat until reach NUM_USE

__C.DATASET.VIDEOS_PER_EPOCH = 200000 #默认的数量600000, 64000, 32000
