...
class ExperimentGOT10k(object):
    ...
    """
    def __init__(self, root_dir, subset='val', trackername='',
    ...
    def run(self, tracker, visualize=False):
        ...
        print('Running tracker %s on GOT-10k...' % self.tracker_name)
        ...
        for s, (img_files, anno) in enumerate(self.dataset):
            ...
            for r in range(self.repetitions):
                ...
                record_file = os.path.join(
                    self.result_dir, self.tracker_name, seq_name,
    ...
    def report(self, tracker_names):
        ...
        if self.subset == 'test':
            ...
            for tracker_name in tracker_names:
                ...
                # result_dir = os.path.join('hp_result-rsm/GOT-10k', tracker_name)
                os.chdir(result_dir)
