...
parser.add_argument('--snapshot', default='./models/siamrpnpp_alexnet/snapshot/checkpoint_e41.pth',type=str, help='snapshot of model')
parser.add_argument('--dataset', default='VOT2018',type=str, help='dataset name to eval')
parser.add_argument('--penalty-k', default='0.12,0.13,0.16', type=parse_range)  # 0.16  
parser.add_argument('--lr', default='0.28,0.30,0.31,0.32,0.33,0.34,0.35', type=parse_range) # 0.30   
parser.add_argument('--window-influence', default='0.36,0.37,0.38,0.39,0.40,0.41,0.42', type=parse_range) # 0.40  
