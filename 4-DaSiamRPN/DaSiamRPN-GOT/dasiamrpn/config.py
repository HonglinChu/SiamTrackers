...
class Config:
    ...
    instance_size = 271#默认271             # instance size  修改成255试试?
    ...
    start_lr = 1e-2 # siamrpn++ 里是0.005
    end_lr = 1e-5   # siamrpn++ 里是0.0005
    #--------------
    warm_lr = 1e-3   #
    ...
    penalty_k =0.22#0.22 #0.22       
    window_influence = 0.40#0.40 #0.40
    lr_box =0.30 #0.30
    min_scale = 0.1
    max_scale = 10
